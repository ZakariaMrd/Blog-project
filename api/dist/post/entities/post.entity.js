...
let Post = class Post {
    slugifyPost() {
        this.slug = (0, slugify_1.default)(this.title.substr(0, 20), { lower: true, replacement: '-' });
    }
};
exports.Post = Post;
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => category_entity_1.Category, category => category.post, { eager: true }),
